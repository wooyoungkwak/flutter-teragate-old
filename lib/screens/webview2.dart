...
class webview2 extends StatefulWidget {
  ...
  final String data1;
  final String data2;
  const webview2(this.data1,this.data2);
...
class _webview2State extends State<webview2> {
  ...
  String? userId = "";
  String? userPassward = "";
  String addres = "http://192.168.0.164:8080/signInapp";
  String URL = "";
  ...
  Widget build(BuildContext context) {
    print("웹 실행");
          param = {
        "loginId": widget.data1,
        "password": widget.data2,
      };

    return Scaffold(
        appBar: AppBar(title: Text("Groupware Hi5")),
        body: SafeArea(
